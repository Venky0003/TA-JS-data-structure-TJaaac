...
console.log(movies[movies.length-1].genres);
...
if(movies[0].year && movies[1].year && movies[2].year > "2017"){
  console.log(true);
}
else{
  console.log(false);
...
if(movies[0].title === "Hannah"){
  ...
  console.log(`title is not Hannah`);
}
// 25. Log the number of actors in all three movies one by one
for(actor of movies[0].actors){
  console.log(actor);
}
for(actor of movies[1].actors){
  console.log(actor)
}
for(actor of movies[2].actors){
  console.log(actor)
}
