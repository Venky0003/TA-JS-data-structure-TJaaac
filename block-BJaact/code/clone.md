...
```
```js
let questionClone = [{...qusetions[0],responses:[..questions[0].responses]},
{...qusetions[1],responses:[..questions[1].responses]}];
```
...
```
```js
let allBlogsClone ={...allBlogs,author:{...allBlogs.author},
comments:[...allBlogs.comments[0]],
comments:[...allBlogs.comments[0]]
};
```
